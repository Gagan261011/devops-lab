...
# Install basic packages and Java (for the Spring Boot app)
apt-get install -y python3 python3-pip openssh-server sudo openjdk-17-jdk curl
...
echo "Ready to accept connections from Ansible master and host the application"
